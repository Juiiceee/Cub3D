...
#    Updated: 2024/06/29 15:56:17 by lbehr            ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
SRC_DIR		:= src
OBJ_DIR		:= obj
SRCS		:= gnl/get_next_line.c map/mapSize.c map/mapUtils.c map/mapAreaCreate.c utils/utilsfree.c map/mapChecker.c map/mapCreate.c map/mapColor.c map/mapTexture.c main.c init/initTexture.c utils/utils.c
